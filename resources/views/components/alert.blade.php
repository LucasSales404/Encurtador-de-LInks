<div
    class="absolute hidden content-alert z-50 w-full h-[calc(100vh-80px)] flex justify-center items-center backdrop-blur-sm bg-black/30">
    <div class="card-view bg-neutral-800 w-[500px] h-[180px] flex flex-col gap-4 px-10 justify-center rounded-md">
        <div class="header-card w-full h-[30px] flex items-center gap-[4px]">
