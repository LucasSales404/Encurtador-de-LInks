...
<main class="">
    <section
        ...
        <div class="cards-features w-[750px] h-[300px] flex gap-[15px]">
            <div class="card w-[250px] h-[250px] p-6 flex justify-center items-center flex-col border-[3px] rounded-[5px] gap-[12px]">
            ...
            <div class="card w-[250px] h-[250px] p-6 flex justify-center items-center flex-col border-[3px] rounded-[5px] gap-[12px]">
                ...
                <div class="description flex justify-center items-center ">
                    <p class="text-[14px] text-center">Use nosso site sem custos, com todas as funcionalidades disponíveis.</p>
                </div>
            </div>
            ...
            <div class="card w-[250px] h-[250px] p-6 flex justify-center items-center flex-col border-[3px] rounded-[5px] gap-[12px]">
                ...
                <div class="description flex justify-center items-center ">
                    <p class="text-[14px] text-center">Transforme links longos em URLs curtas e fáceis de compartilhar.</p>
                </div>
            </div>
        </div>
    </section>
